...
const fullTestRepoUrl = 'git@github.com:zapier/zapier-platform-app-converted-full-test.git';
...
child.on('exit', (code) => console.log(`Finished with code "${code.toString()}"!`));
