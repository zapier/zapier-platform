...
* **Type** - `object`
* [**Source Code**](https://github.com/zapier/zapier-platform/blob/zapier-platform-schema@16.5.0/packages/schema/lib/schemas/FieldDynamicChoicesSchema.js)

#### Properties

Key | Required | Type | Description
--- | -------- | ---- | -----------
`perform` | **yes** | oneOf([/FunctionSchema](#functionschema), [/RequestSchema](#requestschema)) | _No description given._
...
`choices` | no | oneOf([/FieldChoicesSchema](#fieldchoicesschema), [/FieldDynamicChoicesSchema](#fielddynamicchoicesschema)) | An object of machine keys and human values to populate a static or dynamicdropdown.
`placeholder` | no | `string` | An example value that is not saved.
