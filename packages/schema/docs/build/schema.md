...
* **Type** - `object`
* [**Source Code**](https://github.com/zapier/zapier-platform/blob/zapier-platform-schema@16.3.0/packages/schema/lib/schemas/AuthFieldSchema.js)
...
* [**Source Code**](https://github.com/zapier/zapier-platform/blob/zapier-platform-schema@16.3.0/packages/schema/lib/schemas/AuthFieldsSchema.js)
...
`fields` | no | [/AuthFieldsSchema](#authfieldsschema) | **DEPRECATED: use inputFields/outputFields instead** fields requested from the user before they connect the app.
