...
If you are looking for docs from a different version you switch to the tag that corresponds to the version you want to see docs for.

For example, if you want to see docs for version 17.7.0 you can switch to the tag 'zapier-platform-schema@17.7.0' in the GitHub repository.

Alternatively, you can also change the URL to https://github.com/zapier/zapier-platform/blob/zapier-platform-schema@17.7.0/packages/schema/docs/build/schema.md and replacing the version number with the version you want to see docs for.
