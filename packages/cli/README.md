...
Ensure you're handling errors correctly for your platform version. The latest released version is **15.9.1**.
...
The most recently released version of `cli` and `core` is **15.9.1**. You can see the versions you're working with by running `zapier -v`.
