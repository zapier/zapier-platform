module.exports = {
  ...
  role: [
    {
      value: 'employee',
      name: 'I am employed by [app_title]',
    },
    {
      value: 'contractor',
      name: 'I was hired by [app_title] to develop this integration',
    },
    {
      value: 'user',
      name: 'I have no affiliation with [app_title]',
    },
  ],
  app_category: [
    {
