...
RegisterCommand.flags = buildFlags({
  commandFlags: {
    ...
    url: flags.string({
      char: 'u',
      description:
        'The homepage URL of your app. This will also be used as the email domain that would allow team members to join your integration as a Collaborator. Learn more.',
    }),
