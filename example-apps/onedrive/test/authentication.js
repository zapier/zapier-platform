...
describe('Authentication', () => {
  ...
  it('should generate an authorize URL', (done) => {
    ...
    appTester(App.authentication.oauth2Config.authorizeUrl, bundle)
      .then((authorizeUrl) => {
        authorizeUrl.should.eql('https://login.microsoftonline.com/common/oauth2/v2.0/authorize?client_id=1234&redirect_uri=http%3A%2F%2Fzapier.com%2F&response_type=code&state=4444');
        done();
      })
      .catch(done);
  });
