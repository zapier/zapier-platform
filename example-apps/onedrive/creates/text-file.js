...
const createTextFile = (z, bundle) => {
  ...
  return baseItem.handleCreateWithSession(z, bundle, bundle.inputData.file, fileSize, contentType, folder, name);
};
  ...
  operation: {
    inputFields: [
      ...
      },
      {
        ...
        required: true,
        helpText: 'Specify the name of this file. ".txt" will always be appended.',
      },
    ],
