...
- :scroll: Fix missing `key` property in the `.zapierapprc` file after running the `zapier convert` command
- :scroll: Fix duplicate authentication field keys being generated by the `zapier convert` command
...
- :exclamation: Deprecate the `important` key of the `BasicDisplaySchema`. This property will be removed in the next major version release.
